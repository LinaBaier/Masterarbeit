...
% FUNCTION IS SUBTLE MODIFICATION OF FUNCTION FROM JAVAPLEX!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   it also saves it to a file. It also returns a handle to the figure drawn.
    ...
    for dimension = min_dimension:max_dimension
        ...
        if (side_by_side)
            subhandle = subplot(1, double(max_dimension + 1 - min_dimension), double(dimension + 1 - min_dimension));
        else
            subhandle = subplot(double(max_dimension + 1 - min_dimension), 1, double(dimension + 1 - min_dimension));
        end
